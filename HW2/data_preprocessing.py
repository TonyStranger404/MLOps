...
def to_teach_and_separate_data():
    df = pd.read_csv('F:/Games/JetBrains/Projects/MLOps/MLOps/HW2/california-housing-prices/housing.csv')
    ...
    X_train.to_csv('F:/Games/JetBrains/Projects/MLOps/MLOps/HW2/train/X_train.csv', index=False)
    y_train.to_csv('F:/Games/JetBrains/Projects/MLOps/MLOps/HW2/train/y_train.csv', index=False)

    X_val.to_csv('F:/Games/JetBrains/Projects/MLOps/MLOps/HW2/test/X_val.csv', index=False)
    y_val.to_csv('F:/Games/JetBrains/Projects/MLOps/MLOps/HW2/test/y_val.csv', index=False)
