...
def model_preparation():
    X_train = pd.read_csv("F:/Games/JetBrains/Projects/MLOps/MLOps/HW2/train/X_train.csv")
    y_train = pd.read_csv("F:/Games/JetBrains/Projects/MLOps/MLOps/HW2/train/y_train.csv").squeeze()
    ...
    joblib.dump(pipe_all, 'F:/Games/JetBrains/Projects/MLOps/MLOps/HW2/model/DecisionTreeRegressor_model.pkl')
